...
class ShoesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shoe" do
    assert_difference('Shoe.count') do
      post shoes_url, params: { shoe: { color: @shoe.color, size: @shoe.size, style: @shoe.style } }
    end
  ...
  test "should update shoe" do
    patch shoe_url(@shoe), params: { shoe: { color: @shoe.color, size: @shoe.size, style: @shoe.style } }
